const About = () => {
  return (
    <div
      id="about"
      className="absolute left-52 top-[740px] flex flex-row gap-1"
    >
      <div className="flex flex-col">
        ...
        <div className="relative top-7 flex max-w-3xl flex-col gap-4">
        ...
        <div className="relative top-16 flex max-w-3xl flex-col gap-4">
          <p className="font-mono text-2xl font-semibold text-black">
            PERSPECTIVE OF LIFE
          </p>
          <p className="font-mono text-lg font-medium text-black">
        ...
        <div className="relative top-24 flex max-w-3xl flex-col gap-4">
